...
type Variant = 'primary' | 'secondary' | 'outline' | 'link' | 'iconLink';
...
export const BUTTON_VARIANTS = {
  ...
  iconLink: 'bg-transparent border min-w-fit border-none focus:ring-0 hover:text-white disabled:pointer-events-none',
} as const;
